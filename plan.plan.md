...
- `/devices/grid` - сетка устройств с экранами в реальном времени (стриминг)
...
- DeviceList, DeviceGrid (сетка устройств с экранами), DeviceScreen, TaskList, LogViewer, ScreenshotViewer
 2.5 Docker Compose
...
### 2.6 Вывод экранов устройств в реальном времени (дополнение) — 7–10 дней — $500
...
│   │   │   │   └── Screenshot.kt
│   │   │   ├── streaming/
│   │   │   │   └── ScreenCaptureService.kt (захват и стриминг экрана)
│   │   │   ├── network/
│   │   │   │   ├── ProxyManager.kt
│   │   │   │   └── ApiClient.kt
│   │   │   └── utils/
...
- `ScreenCaptureService.kt` - сервис захвата и стриминга экрана
  - Захват скриншотов каждые 1–2 секунды
  - Оптимизация изображений (сжатие, уменьшение разрешения)
  - Отправка через WebSocket на backend
...
**Этап 1:** Проектирование — 10 дней — $400  
**Этап 2:** Backend + Очередь + Минимальный UI — 20 дней — $1,700  
**Этап 2.6:** Вывод экранов устройств в реальном времени (дополнение) — 7–10 дней — $500  
**Этап 3:** Android Agent (APK) — 20 дней — $2,000  
**Этап 4:** Хранение и экспорт, артефакты — 10 дней — $300  
**Этап 5:** Интеграция, тестирование, передача — 10 дней — $600  
